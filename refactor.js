...
// Replace Auth & Access Control block entirely
const authBlockRegex = /test\.describe\('1\. Auth & Access Control[\s\S]*?\}\);\n  \}\);/m;
...
content = content.replace(authBlockRegex, newAuthBlock);

// Replace TC IDs and descriptions directly
const replacements = [
  // Upload
  { old: /test\.describe\('2\. File Upload Validations.*/g, new: "test.describe('2. File Upload Validations (TC-008 to TC-010)', () => {" },
...
fs.writeFileSync('tests/import-project.spec.ts', content);
